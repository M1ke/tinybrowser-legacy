...
if(!$standalone && $tinybrowser['integration']=='tinymce')
	{
	?><script language="javascript" type="text/javascript" src="<?php echo $tinybrowser['tinymcepopup']; ?>"></script>
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo $tinybrowser['tinymcecss']; ?>" /><?php
	}
else
	{
	?><link rel="stylesheet" type="text/css" media="all" href="<?php echo $tinybrowser['script']?>css/stylefull_tinybrowser.css" /><?php 
	}
?>
<link rel="stylesheet" type="text/css" media="all" href="<?php echo $tinybrowser['script']?>css/style_tinybrowser.css.php" />
<script language="javascript" type="text/javascript" src="<?php echo $tinybrowser['script']?>js/tinybrowser.js.php?<?php echo substr($passfeid,1); ?>"></script>
</head>
