...
<script type="text/javascript" src="<?php echo $tinybrowser['script']?>js/swfobject.js"></script>
...
<body onload='
      var so = new SWFObject("<?php echo $tinybrowser['script']?>flexupload.swf", "mymovie", "100%", "340", "9", "#ffffff");
